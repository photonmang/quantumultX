...
function qqreadbox() {
  return new Promise((resolve, reject) => {
    const toqqreadboxurl = {
      url: "https://mqqapi.reader.qq.com/mqq/red_packet/v2/user/treasure_box?"+"qqreadboxVal",
      headers: JSON.parse(qqreadtimeheaderVal),
      timeout: 60000,
    };
...
function qqreadbox2() {
  return new Promise((resolve, reject) => {
    const toqqreadbox2url = {
      url:
          "https://mqqapi.reader.qq.com/mqq/red_packet/v2/user/treasure_box_video?"+"qqreadboxvideoVal",
