...
[task_local]
#签到领现金
2 0 * * * https://raw.githubusercontent.com/photonmang/quantumultX/master/cache/jd/jd_cash.js, tag=签到领现金, enabled=true

================Loon==============
[Script]
cron "2 0 * * *" script-path=https://raw.githubusercontent.com/photonmang/quantumultX/master/cache/jd/jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/photonmang/quantumultX/master/cache/jd/jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path=https://raw.githubusercontent.com/photonmang/quantumultX/master/cache/jd/jd_cash.js, cronexpr="2 0 * * *", timeout=200, enable=true
 */
const $ = new Env('签到领现金');
...
const inviteCodes = [
  `Ihg-aeS6Z_0m-Gm6iw@ckZoP7TnOPQn9g@Y0NoKLPsO614pg@eU9YN4XLE51cjiifmhpu@eU9YKbH0NKFbmBWurCxB@eU9Ya-TgYfwk-GrRzSATgA@eU9Yauy6MKl092uHyHcTgA@ekpqL7XvOaJyoDc`,
  `Ihgxaem1Zf0n-Gu6iw@eU9Ya-iwZvh3oGjWz3YThQ`
]
if ($.isNode()) {
