...
const suburl = 'https://raw.githubusercontent.com/photonmang/quantumultX/master/config/taskall.json'

const webhook = {
  url: '/webhook',              // 远程： http://sss.xxxx.com/webhook
  token: 'b64685fa-7831-41e9-8707-95dffec41f5d',     // 在 webUI->SETTING 界面查找
}
